 ...
 */
final class Version20190310144533 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `match` (id INT AUTO_INCREMENT NOT NULL, board_id INT NOT NULL, tournament_id INT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, table_name VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, status INT NOT NULL, INDEX IDX_7A5BC50533D1A3E7 (tournament_id), INDEX IDX_7A5BC505E7EC5785 (board_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE match_player (match_id INT NOT NULL, player_id INT NOT NULL, INDEX IDX_397683642ABEACD6 (match_id), INDEX IDX_3976836499E6F5DF (player_id), PRIMARY KEY(match_id, player_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
